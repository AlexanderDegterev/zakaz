object Add_Object: TAdd_Object
  Left = 0
  Top = 0
  BorderStyle = bsSingle
  Caption = #1057#1087#1088#1072#1074#1086#1095#1085#1080#1082' '#1086#1073#1098#1077#1082#1090#1086#1074' - '#1076#1086#1073#1072#1074#1080#1090#1100
  ClientHeight = 179
  ClientWidth = 547
  Color = clBtnFace

object Add_ProdGroup: TAdd_ProdGroup
  Left = 0
  Top = 0
  BorderStyle = bsSingle
  Caption = #1057#1087#1088#1072#1074#1086#1095#1085#1080#1082' '#1075#1088#1091#1087#1087' '#1080#1079#1076#1077#1083#1080#1081' - '#1076#1086#1073#1072#1074#1080#1090#1100
  ClientHeight = 179
  ClientWidth = 547
  Color = clBtnFace
